...
class MCTSSubmission1:
    ...
    def __init__(self, _id, initial_state, time_limit=THINK_TIME, exploration_constant=1, discount_factor=0.9):
        ...
        self.ROW_BONUS = [0.2, 0.8, 1.2, 0.8, 0.2]
    ...
    def expandNode(self):
        ...
        possible_moves = self.pruneMoves(self.game_rule.getLegalActions(self.root.state.azul_state, self.id))
